## Linked work item & DevSpec change

<!-- AB#<id> auto-links the Azure Boards work item and transitions it on merge.
     The change slug ties this PR to the spec in .devspec/projects/<slug>/. -->
